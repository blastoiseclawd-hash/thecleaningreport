export const howWeReviewContent = {
  ...
  description:
    "A transparent overview of how TheCleaningReport researches products, weighs tradeoffs, and updates recommendations over time.",
  intro:
    "Every guide on TheCleaningReport should explain where the research came from, what mattered in the final ranking, and which reader the page is meant to serve.",
  sections: [
    {
...
export const aboutContent = {
  ...
  description:
    "TheCleaningReport publishes independent buying guides built around clear desk voices, real source material, and honest tradeoffs.",
  intro:
    "TheCleaningReport is a starter publication designed to help you launch a niche affiliate site without rebuilding the editorial infrastructure from scratch.",
  whatWeDo:
...
export const disclosureContent = {
  ...
  body:
    "TheCleaningReport may earn a commission when a reader buys through certain links. That commission should never override what is best for the reader, and the page should still be useful without the link.",
  aiTransparency:

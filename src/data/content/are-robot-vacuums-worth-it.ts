...
export const areRobotVacuumsWorthItContent = {
  ...
  heroImage: {
    src: "/images/guides/are-robot-vacuums-worth-it/01-hero-labor-math.png",
    alt: "A teal robot vacuum on a cream floor with a copper clock, a soft arrow showing time reclaimed per week, and a rising curve suggesting value over lifespan. The composition reads as robot vacuum equals time trade.",
  },
  ...
  sections: [
...

    {
      ...
      image: {
        src: "/images/guides/are-robot-vacuums-worth-it/03-where-math-breaks.png",
        alt: "A 2-by-3 grid of six do-not-buy scenarios for robot vacuums: studio apartment with outsized dock, shag-pile carpet, cluttered floor with cords and toys, spilled pet mess spreading from robot tracks, two-story house with stairs, and dark hardwood floor confounding cliff sensors. Each vignette carries a copper circle-with-slash overlay.",
        caption: "Six households where the labor-math never arrives. Most competitor guides soft-pedal these because they contradict affiliate economics.",
      },
      body:
  ...
  relatedLinks: [
    ...
    { href: "/is-roomba-the-best-robot-vacuum", title: "Is Roomba the Best Robot Vacuum? (2026 Honest Take)" },
